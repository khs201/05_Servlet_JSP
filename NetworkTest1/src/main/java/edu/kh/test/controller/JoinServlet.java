...
public class JoinServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		//-----------------------------------------------------------
		String memberId = req.getParameter("memberId"); // name값 밸류가 제대로 적혀있지 않음
		String memberPw = req.getParameter("memberPw"); // name값 밸류가 제대로 적혀있지 않음
		String memberName = req.getParameter("memberName"); // name값 밸류가 제대로 적혀있지 않음
		...
		String path = "/WEB-INF/views/success.jsp"; // 경로가 잘못 지정되어 있다!
